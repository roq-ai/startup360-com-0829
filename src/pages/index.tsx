...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`STARTUP360.COM`}</title>

        <meta
          name="description"
          content="Embrace growth with STARTUP360.COM - your ultimate platform for end-to-end business solutions. We cater to your every need, letting you focus on building your dream business. Find top-notch services, all in one place."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1522071820081-009f0129c71c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxzdGFydHVwc3xlbnwwfHx8fDE2OTQxNjYwMjJ8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Embrace growth with STARTUP360.COM - your ultimate platform for end-to-end business solutions. We cater to your every need, letting you focus on building your dream business. Find top-notch services, all in one place.`}
            </Text>
            <Box
