...
import { PreferredServiceProviderListPage } from 'pages/preferred-service-providers';
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('service_provider', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/service-providers/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Service Type" text={data?.service_type} />
            ...
            <Box borderRadius="10px" border="1px" borderColor={'base.300'} mt={6} p={'18px'}>
              <PreferredServiceProviderListPage
                filters={{ service_provider_id: id }}
                hidePagination={true}
