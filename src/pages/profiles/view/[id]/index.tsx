...
import { getProfileById } from 'apiSdk/profiles';
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('profile', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/profiles/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Bio" text={data?.bio} />

                <FormListItem label="Location" text={data?.location} />

                <FormListItem label="Website" text={data?.website} />

                <FormListItem label="Social Links" text={data?.social_links} />
