...
import { getPlatformById } from 'apiSdk/platforms';
import { PlatformInterface } from 'interfaces/platform';
import { ServiceProviderListPage } from 'pages/service-providers';
            ...
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('platform', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/platforms/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              <EntityImage entity="platform" entityId={id} />
              <List
                w="100%"
                css={{
                  '> li:not(:last-child)': {
